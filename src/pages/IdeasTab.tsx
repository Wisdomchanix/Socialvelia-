  ...
  return (
    <div className="min-h-screen bg-[#05010E] text-white px-6 md:px-16 py-16">
      <div className="max-w-5xl mx-auto text-center">
        ...
        >
          💡 Content Ideas for <span className="text-white">Tech Entrepreneurs</span>
        </motion.h1>

        <p className="text-gray-400 max-w-2xl mx-auto mb-12">
          Fresh, scroll-stopping content ideas to help your niche stand out. Each idea is designed
          to drive engagement and grow your audience organically.
        </p>
