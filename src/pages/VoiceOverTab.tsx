...
const VoiceOverTab: React.FC = () => {
  ...
  const voices = [
    { name: "Alice", desc: "Clear and engaging, friendly tone", color: "#00FFFF" },
    { name: "Bill", desc: "Friendly and comforting voice", color: "#00BFFF" },
    { name: "Brian", desc: "Middle-aged man with a warm tone", color: "#FFD700" },
    { name: "Callum", desc: "Deceptively gravelly, yet calm", color: "#FF69B4" },
  ...
  return (
    <div className="min-h-screen bg-[#05010E] text-white px-4 md:px-10 py-6 flex flex-col relative">
      ...
      <div className="mt-4 flex flex-col md:flex-row justify-between items-center gap-4">
        ...
        <button className="w-full md:w-auto flex items-center justify-center gap-2 bg-[#7209b7] hover:bg-[#f72585] px-6 py-3 rounded-xl text-sm md:text-base font-semibold transition">
          ...
          <>
            ...
            >
              ...
              <div className="flex justify-between items-center mb-4">
                <h3 className="text-lg md:text-xl font-semibold">Select a Voice</h3>
