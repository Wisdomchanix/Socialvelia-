...
const testimonials = [
  ...
  { id: 2, text: "This best so far! I love it an all in one tool", author: "Lydia K." },
  { id: 3, text: "My videos finally go viral.", author: "James I." },
  { id: 4, text: "The voiceover and prompt tools save me hours every week.", author: "Tunde M." },
  { id: 5, text: "Our videos finally bring real sales thanks to Social Velia’s insights.", author: "Chioma O., Business Owner" },
  { id: 6, text: "Every creator I coach now uses Social Velia, it simply works.", author: "Martins A." },
  { id: 7, text: "The voiceover and prompt tools save me hours every week.", author: "Michael C." },
  { id: 8, text: "Super friendly team that actually listens and executes.", author: "Grace E." },
];
        ...
        <div className="columns-2 sm:columns-3 lg:columns-4 gap-4 space-y-4">
          {testimonials.map((t, index) => {
            ...
            return (
              ...
              >
                <p className="text-gray-800 dark:text-gray-200 leading-relaxed mb-3 transition-colors duration-300">{t.text}</p>
                <span className="text-sm text-gray-600 dark:text-gray-300 transition-colors duration-300">— {t.author}</span>
              </div>
            );
          })}
        </div>
