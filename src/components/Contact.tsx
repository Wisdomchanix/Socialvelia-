...
const Contact: React.FC = () => {
  ...
  return (
    <section className="relative bg-white text-gray-900 dark:bg-[#06030D] dark:text-white py-20 px-6 md:px-16 lg:px-28 overflow-hidden transition-colors duration-500" id="contact">
      ...
      <div className="relative max-w-5xl mx-auto text-center mb-14 contactcard">
        ...
        <p className="text-gray-600 dark:text-gray-400 max-w-xl mx-auto">
          Whether you have a question, idea, or feedback we’d love to hear from you.
        </p>
      </div>
      ...
      <div className="relative grid md:grid-cols-2 gap-10 items-start contactcard">
        ...
        <div className="space-y-6">
          <div className="flex items-center gap-4">
            ...
            <p className="text-gray-700 dark:text-gray-300">support@socialvelia.com</p>
          </div>
          <div className="flex items-center gap-4">
            <Phone className="text-[#8B5CF6]" />
            <p className="text-gray-700 dark:text-gray-300">+234 800 000 VELIA</p>
          </div>
          <div className="flex items-center gap-4">
            <MessageSquare className="text-[#8B5CF6]" />
            <p className="text-gray-700 dark:text-gray-300">DM us on X (@socialvelia)</p>
          </div>

          <p className="text-gray-600 dark:text-gray-400 pt-6 leading-relaxed">
            We respond within 24 hours — our team is always ready to help creators and brands
            get the most out of Social Velia.
          </p>
        </div>
