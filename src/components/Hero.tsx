...
const Hero: React.FC = () => {
  ...
  return (
    <>
      <Header />
      <section className="relative overflow-hidden bg-[#05010E] text-white dark:text-white transition-colors duration-500 bg-white dark:bg-[#05010E]" id="home">
          ...
          <div className="flex flex-col lg:flex-row items-center gap-12 lg:gap-24">
            ...
            <div className="w-full lg:w-6/12 text-center lg:text-left hero">
              ...
              <p className="mt-6 text-gray-600 dark:text-gray-300 max-w-xl mx-auto lg:mx-0">
                From niche discovery to viral content creation, SocialVelia gives
                you everything you need to grow fast — even AI tools for movie
                recaps.
              </p>
