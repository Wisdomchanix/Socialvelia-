      ...
      <div className="relative grid md:grid-cols-4 gap-10 max-w-6xl mx-auto">
        ...
        <div>
          ...
          <p className="text-gray-600 dark:text-gray-400 text-sm leading-relaxed">
            Your all-in-one AI content assistant — helping creators discover, plan, and grow faster.
          </p>
        </div>
        ...
        <div>
          ...
          <ul className="space-y-2 text-gray-600 dark:text-gray-400 text-sm">
            <li><a href="#" className="hover:text-[#C084FC] transition">Home</a></li>
            <li><a href="#" className="hover:text-[#C084FC] transition">How It Works</a></li>
            <li><a href="#" className="hover:text-[#C084FC] transition">Testimonials</a></li>
            <li><a href="#" className="hover:text-[#C084FC] transition">Contact</a></li>
          </ul>
        </div>
        ...
        <div>
          ...
          <ul className="space-y-2 text-gray-600 dark:text-gray-400 text-sm">
            <li><a href="#" className="hover:text-[#C084FC] transition">AI Content Assistant</a></li>
            <li><a href="#" className="hover:text-[#C084FC] transition">Voiceover Generator</a></li>
            <li><a href="#" className="hover:text-[#C084FC] transition">Prompt Writer</a></li>
            <li><a href="#" className="hover:text-[#C084FC] transition">Trend Research</a></li>
          </ul>
        </div>
